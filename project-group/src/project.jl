...
begin
	...
	Plots.savefig(fig_1, "artifacts/JL.plot01.png")
end
...
begin
	...
	Plots.savefig(fig_2, "artifacts/JL.plot02.png")
end
...
begin
	...
	Plots.savefig(fig_3, "artifacts/JL.plot03.png")
end
...
begin
	...
	Plots.gif(anim, fps=60, "artifacts/JL.anim01.gif")
end
...
begin
	...
	Plots.gif(anim1, fps=60, "artifacts/JL.anim02.gif")
end
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "072932ee2ecf7d1140ded4a5e34e96d111b697b4"
